> ✏️ **This page is auto-generated from [`scripts/overview/overview_3_statistical_methods.py`](../../scripts/overview/overview_3_statistical_methods.py) — do not edit it directly.**
> It shows the example fully executed, with its real output images.
> Run it yourself via the [Python script](../../scripts/overview/overview_3_statistical_methods.py) or the [Jupyter notebook](../../notebooks/overview/overview_3_statistical_methods.ipynb).
