...
# the data (e.g. 'Line'). We advise that the dataset class is give a more specific name (e.g., if your dataset is
# imaging data, the class may be called 'Imaging'. If your dataset is a spectrum, you may use 'Spectrum').
#
# However, because you're new to PyAutoFit we've stuck with the name 'Dataset' for clarity. The example project at the
# end of the chapter will adopt a more specific dataset naming conventioon.
