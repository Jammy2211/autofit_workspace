...
from howtofit.chapter_1_introduction.tutorial_5_complex_models.src.fit import fit as f
from howtofit.chapter_1_introduction.tutorial_5_complex_models.src.phase import (
    visualizer,
)

# The 'analysis.py' module in this tutorial is changed from tutorial 4, such that the fit function now assumes multiple
...
class Analysis(af.Analysis):
    ...
    def model_data_from_instance(self, instance):
        ...
        #     model_data += profile.line_from_xvalues(xvalues=self.masked_dataset.xvalues)

        # return model_data

    def fit_from_model_data(self, model_data):
        return f.DatasetFit(masked_dataset=self.masked_dataset, model_data=model_data)
