...
# %%
data_path = f"{dataset_path}/gaussian_x1_exponential_x1"
...
# %%
model_line = gaussian.line_from_xvalues(
    xvalues=xvalues
...
# %%
data_path = f"{dataset_path}/gaussian_x2_exponential_x1"
...
# %%
data_path = f"{dataset_path}/gaussian_x3"
