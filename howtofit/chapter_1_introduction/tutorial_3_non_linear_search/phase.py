...
from howtofit.chapter_1_introduction.tutorial_3_non_linear_search.result import Result
from howtofit.chapter_1_introduction.tutorial_3_non_linear_search.analysis import (
    Analysis,
)
...
class Phase(af.AbstractPhase):
    ...
    def make_analysis(self, dataset):
        ...
        analysis : Analysis
            ...
            instance.
        """
        return Analysis(imaging=dataset)
